...
<h5><small><?php _e('Step 3', 'woocommerce'); ?></small><a href="#"><?php _e('Delivery Details', 'woocommerce'); ?></a></h5>
<?php }else{?>
<h5><small><?php _e('Step 4', 'woocommerce'); ?></small><a href="#"><?php _e('Delivery Details', 'woocommerce'); ?></a></h5>
<?php }?>
