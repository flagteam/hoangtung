		...
		switch ( $handler ) {
			...
			default :
				if ( $product->is_purchasable() ) {
					...
					$link['class']  = apply_filters( 'add_to_cart_class', 'one tooltip' );
				} else {
