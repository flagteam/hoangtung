...
<?php else : ?>
	...
	<form action="<?php echo esc_url( add_query_arg( 'address', $load_address, get_permalink( woocommerce_get_page_id('edit_address') ) ) ); ?>" class="billing-form"method="post">
		...
		?>
                ...
                <br>
			<input type="submit" class="red-button" name="save_address" value="<?php _e( 'Save Address', 'woocommerce' ); ?>" />
