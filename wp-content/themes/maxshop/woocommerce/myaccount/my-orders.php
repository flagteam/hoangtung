...
if ( $customer_orders ) : ?>
	...
	<h2><?php echo apply_filters( 'woocommerce_my_account_my_orders_title', __( 'Recent Orders', 'woocommerce' ) ); ?></h2>
        <div class="billing"> 
			...
			<ul class="title my-orders">
				<li class="order-number"><span class="nobr"><?php _e( 'Order', 'woocommerce' ); ?></span></li>
				<li class="order-date"><span class="nobr"><?php _e( 'Date', 'woocommerce' ); ?></span></li>
				<li class="order-status"><span class="nobr"><?php _e( 'Status', 'woocommerce' ); ?></span></li>
				<li class="order-total"><span class="nobr"><?php _e( 'Total', 'woocommerce' ); ?></span></li>
				<li class="order-actions">&nbsp;</th>
			</ul>
<?php
			foreach ( $customer_orders as $customer_order ) {
				...
				?><ul class="order my-orders">
					...
					<li class="order-status" style="text-align:left; white-space:nowrap;">
