...
$options = array(
    ...
    array(
		...
		'tab_id' => 'woocommerce-section'
	) ,
    array(
		'name' => 'Product layout',
		'id' => $shortname . '_prlayout',
		'type' => 'select',
		'desc' => 'Choose layout type of products',
		'options' => array(
	...
	array(
		...
		array(
			'name' => 'Content top background Image',
			'id' =>   $shortname.'_content_bg',
			'type' => 'upload',
			'std' => '',
			'desc' => 'Content top background image. Upload an image or specify an existing url.'
		),
