...
function wp_pagenavi($before = '', $after = '') {
	...
	$pagenavi_options = array(
		...
		'next_text' => __('>','Maxshop'),
		'prev_text' => __('<','Maxshop'),
...
function pagenavi_init() {
	...
	$pagenavi_options = array(
		...
		'current_text' => '%PAGE_NUMBER%',
		'page_text' => '%PAGE_NUMBER%',
		'first_text' => __('','Maxshop'),
		'last_text' => __('','Maxshop'),
		'next_text' => __('>','Maxshop'),
		'prev_text' => __('<span class="icon-chevron-left"></span>','Maxshop'),
		'dotright_text' => __('...','Maxshop'),
		'dotleft_text' => __('...','Maxshop'),
		'style' => 1,
		'num_pages' => 5,
		'always_show' => 0,
		'num_larger_page_numbers' => 3,
